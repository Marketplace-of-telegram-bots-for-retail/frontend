...
export const goodsHint = {
  categoryFirst: 'Обязательное поле.',
  categorySecond: 'Если в списке нет подходящей категории, обратитесь, пожалуйста, в Службу поддержки через ',
  categorySpan: 'форму обратной связи.',
  nameBot: 'Обязательное поле.',
  description: 'Обязательное поле. Краткое описание назначения бота. Первые 95 символов будут отображаться в карточке на витрине Каталога. Полный текст будет виден на странице товара.',
};