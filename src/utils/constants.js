...
export const goodsHint = {
  ...
  category: 'Если в списке нет подходящей категории, обратитесь, пожалуйста, в Службу поддержки через ',
  categorySpan: 'форму обратной связи.',
  descriptionFirst: 'Краткое описание назначения бота.',
  descriptionSecond: 'Первые 95 символов будут отображаться в карточке на витрине Каталога. Полный текст будет виден на странице товара.',
  function: 'Функции будут расположены под основным описанием в виде маркированного списка (до 5 функций).',
  photo: 'Вы можете загрузить до 10 фотографий в формате jpg, png. Размер до 5 Мб.',
