    ...
    <section className="seller">
      <div className="seller__promo">
        <div className="seller__info">
          ...
          <button type="button" onClick={onRegister} className="seller__button">Стать продавцом</button>
        </div>
      ...
      <ul className="seller__steps">
        {steps.map(({ title, text, number, image }) => (
          <li key={number} className="seller__step">
            ...
            <img src={image} alt="Декоративное изображение для описания этапа" className={`seller__step-picture seller__step-picture_type_${number}`} />
          </li>
        ))}
      </ul>
      <div>
        <div className="seller__banner">
          ...
          <div className="seller__banner-items">
            <div className="seller__banner-illustrations">
              <img className="seller__banner-nums" src={banner_nums} alt="Графическое изображение скидки 5-10%" />
