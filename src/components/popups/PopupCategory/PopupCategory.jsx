...
function PopupCategory({ isOpen, onClose }) {
  ...
  return (
    <div className={`popup__category ${isOpen && 'popup__category_opened'}`}>
      ...
      <div className='popup__text-group'>
        <p className='popup__text'>
          {goodsHint.categoryFirst}
          <br />
          {goodsHint.categorySecond}
          <span className='popup__text popup__text_type_span'>{goodsHint.categorySpan}</span>
        </p>
      </div>
    </div>
  );
